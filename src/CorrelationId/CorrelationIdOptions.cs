namespace CorrelationId
{
	...
	public class CorrelationIdOptions
	{
		...
		private const string DefaultHttpContextItemName = "CorrelationId"; 
		...
		/// <summary>
		/// CorrelationId Item's name in HttpContext.Items
		/// </summary>
		public string HttpContextItemName { get; set; } = DefaultHttpContextItemName;
